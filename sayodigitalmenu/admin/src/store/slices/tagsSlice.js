...
export const fetchTags = createAsyncThunk('tags/fetchAll', () => mockApi.tags.getAll());
export const createTag = createAsyncThunk('tags/create', (data) => mockApi.tags.create(data));
export const updateTag = createAsyncThunk('tags/update', ({ id, updates }) => mockApi.tags.update(id, updates));
export const deleteTag = createAsyncThunk('tags/delete', (id) => mockApi.tags.delete(id));
