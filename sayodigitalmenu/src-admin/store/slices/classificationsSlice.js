...
export const fetchClassifications = createAsyncThunk('classifications/fetchAll', () => api.classifications.getAll());
export const createClassification = createAsyncThunk('classifications/create', (data) => api.classifications.create(data));
export const updateClassification = createAsyncThunk('classifications/update', ({ id, updates }) => api.classifications.update(id, updates));
export const deleteClassification = createAsyncThunk('classifications/delete', (id) => api.classifications.delete(id));
export const reorderClassifications = createAsyncThunk('classifications/reorder', ({ mainSectionId, orderedIds }) =>
  api.classifications.reorder(mainSectionId, orderedIds)
);
